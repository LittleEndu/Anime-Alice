...
class Alice(commands.Bot):
    def __init__(self, config_name='config.json'):
        ...
        fh = RotatingFileHandler("logs/alice.log", maxBytes=1000000, encoding='UTF-8')
        fh.setLevel(logging.INFO)
        fh.setFormatter(formatter)
        dh = RotatingFileHandler("logs/debug.log", maxBytes=1000000, encoding='UTF-8')
        dh.setLevel(1)
        dh.setFormatter(formatter)
        th = RotatingFileHandler("logs/trace.log", maxBytes=1000000, encoding='UTF-8')
        th.setLevel(1)
